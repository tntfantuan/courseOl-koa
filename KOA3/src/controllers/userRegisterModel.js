 ...
 * @Last Modified time: 2020-01-16 00:28:14
 */
...
var userRegister = async (ctx, next) => {
    ...
    if (ctx.request.body[0].userSex == '男') { 
        thisRegisterData[0].userHeadimg = 'http://192.168.2.128:3000/src/assets/user/default/M.jpg';
    } else {
        thisRegisterData[0].userHeadimg = 'http://192.168.2.128:3000/src/assets/user/default/G.jpg';
     }
    ...
    thisRegisterData[0].userName = ctx.request.body[0].userName;
    ...
    thisRegisterData[0].userSex = ctx.request.body[0].userSex;
    thisRegisterData[0].userIdnumber = '';
    thisRegisterData[0].userSchool = ctx.request.body[0].userSchool;
